...
Utilizator::Utilizator(const std::string& nume, const std::string& prenume, const std::string& email, const std::string& parola)
    : m_Nume(nume), m_Prenume(prenume), m_Email(email), m_Parola(parola) {
}
